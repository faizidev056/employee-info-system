        ...
        <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-4 relative overflow-hidden font-sans">
            ...
            >
                ...
                <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] border border-white shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)] p-8 md:p-10">
                    ...
                    <div className="mt-6 p-4 rounded-[1.25rem] bg-emerald-500/5 border border-emerald-500/10">
                        <p className="text-[11px] font-bold text-emerald-800 mb-2 uppercase tracking-wider">Security Requirements:</p>
