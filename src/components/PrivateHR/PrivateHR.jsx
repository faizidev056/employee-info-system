                        ...
                        {workers.slice(0, 5).map(worker => (
                          <tr key={worker.id} className={`group transition-all ${darkMode ? 'hover:bg-white/5' : 'hover:bg-purple-50/30'}`}>
                            ...
                            <td className="px-8 py-4 text-center">
                              <div className={`inline-flex items-center justify-center w-20 px-2 py-0.5 rounded-full text-[9px] font-medium uppercase tracking-tighter ${(worker.status === 'Active' || !worker.status) ? 'text-emerald-500 bg-emerald-500/10' : 'text-rose-500 bg-rose-500/10'}`}>
