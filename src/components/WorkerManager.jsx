        ...
        {activeTab === 'dashboard' && (
          ...
          >
            <motion.div
              ...
              className="mb-8 pb-4 border-b border-gray-200/60"
            >
              <h2 className="text-3xl font-semibold text-slate-900 mb-1.5">
                Dashboard
              </h2>
                ...
                >
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 text-sm">Latest employee additions</p>
                    </div>
                  </div>
                  <div className="space-y-3">
                    {workers.slice(0, 5).map((worker, index) => (
                      <motion.div
                        ...
                        className="group relative overflow-hidden flex items-center justify-between p-4 bg-gray-50 hover:bg-white border border-gray-100 hover:border-gray-200 rounded-xl transition-all duration-300 cursor-pointer shadow-sm hover:shadow"
                      >
                        <div className="relative z-10 flex items-center gap-3">
                          <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center text-slate-600 font-bold text-sm border border-gray-200 flex-shrink-0">
                            {index + 1}
                          </div>
                          <div>
                            <p className="text-slate-900 font-semibold text-sm group-hover:text-cyan-700 transition-colors">{worker.full_name}</p>
                            <p className="text-slate-500 text-xs">{worker.designation} • {worker.uc_ward_name}</p>
                          </div>
                        </div>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="bg-white/40 border-b border-white/50 text-xs backdrop-blur-sm">
                        ...
                        <th className="px-4 py-3 text-left font-semibold text-slate-500 uppercase tracking-wider hidden sm:table-cell w-28">UC/Ward</th>
                          ...
                          >
                            <td className="px-3 py-2">
                              <div className="flex items-center gap-3">
                                <div className="w-7 h-7 bg-gradient-to-br from-slate-700 to-slate-600 rounded-lg flex items-center justify-center text-slate-900 font-semibold text-xs border border-slate-500/30 flex-shrink-0 min-w-7">
                                  {index + 1}
                                </div>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-slate-600 text-sm max-w-32 truncate">{worker.uc_ward_name}</div>
                              {worker.attendance_point && (
                                <div className="text-slate-500 text-xs max-w-32 truncate" title={worker.attendance_point}>
                                  {worker.attendance_point}
                                </div>
                              )}
                            </td>
